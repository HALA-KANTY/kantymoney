...
<head>
    ...
    <title>KantyMoney • Gestion des Frais d'Envoi</title>
...
<body>
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <a href="gestionFraisEnvoi" class="nav-item active"><i class="fas fa-paper-plane"></i><span>Frais d'envoi</span></a>
            </div>
            <div class="nav-section">
    ...
    <main class="main-content">
        ...
        <%
            List<String[]> liste = (List<String[]>) request.getAttribute("listeFrais");
        ...
        <div class="table-container">
            <div class="table-header">
                <h3><i class="fas fa-list-ul"></i> Liste des frais d'envoi</h3>
                ...
                <table>
                    ...
                    <tbody id="tableBody">
                        <% if (liste != null && !liste.isEmpty()) {
                            for (String[] f : liste) { %>
                            <tr class="tarif-item" data-search="tranche <%= f[0] %> <%= f[1] %> <%= f[2] %> <%= f[3] %>">
                                <td>
                                    <span class="tranche-badge">
                                        <i class="fas fa-tag"></i> N°<%= f[0] %>
                                    </span>
                                </td>
                                <td class="montant-cell"><%= MoneyFormat.formatNullable(f[1]) %> Ar</td>
                                <td class="montant-cell"><%= MoneyFormat.formatNullable(f[2]) %> Ar</td>
                                <td class="frais-cell"><%= MoneyFormat.formatNullable(f[3]) %> Ar</td>
                                <td style="text-align: center;">
                                    <div class="action-buttons" style="justify-content: center;">
                                        <button class="btn-action btn-edit" onclick='openModal("edit", "<%= f[0] %>", <%= f[1] %>, <%= f[2] %>, <%= f[3] %>)'>
                                            <i class="fas fa-pen"></i> Modifier
                                        </button>
                                        <button class="btn-action btn-delete" onclick='openConfirmDelete("<%= f[0] %>", "<%= MoneyFormat.formatNullable(f[1]) %>", "<%= MoneyFormat.formatNullable(f[2]) %>", "<%= MoneyFormat.formatNullable(f[3]) %>")'>
                            ...
                            <tr id="emptyRow">
                                <td colspan="5">
                                    <div class="empty-state">
                                        ...
                                        <p>Commencez par ajouter votre première tranche tarifaire</p>
                                    </div>
                                </td>
                            </tr>
                        <% } %>
            ...
            <div class="pagination-container" id="paginationContainer" style="<%= (liste == null || liste.isEmpty()) ? "display:none;" : "" %>">
    ...
    <div class="modal-overlay" id="modalOverlay">
        <div class="modal">
            <div class="modal-header">
                <h3 id="modalTitle"><i class="fas fa-plus-circle"></i> Nouveau tarif</h3>
                <button class="modal-close" onclick="closeModal()"><i class="fas fa-times"></i></button>
            </div>
            <form action="gestionFraisEnvoi" method="POST" id="fraisForm">
                <input type="hidden" name="action" id="formAction" value="create">
                <input type="hidden" name="idEnv" id="tarifId">
                <div class="modal-body">
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="number" name="montant2" id="montantMax" placeholder="10000" required>
                                <span class="unit">Ar</span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="fraisEnv"><i class="fas fa-coins"></i> Frais d'envoi</label>
                        <div class="input-wrapper">
                            <input type="number" name="frais_env" id="fraisEnv" placeholder="500" required>
                            <span class="unit">Ar</span>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-overlay" id="confirmDeleteModal">
        <div class="modal">
            ...
            <div class="modal-footer">
                ...
                <form action="gestionFraisEnvoi" method="POST" id="deleteForm" style="flex:1;display:flex;">
                    <input type="hidden" name="action" value="delete">
                    <input type="hidden" name="idEnv" id="deleteIdEnv">
    ...
    <script>
        ...
        const fraisEnv = document.getElementById('fraisEnv');
        const submitBtn = document.getElementById('submitBtn');

        // ===== MODAL CONFIRMATION SUPPRESSION =====
        const confirmDeleteModal = document.getElementById('confirmDeleteModal');
        const confirmDetail = document.getElementById('confirmDetail');
        const deleteIdEnv = document.getElementById('deleteIdEnv');
        ...
        function openModal(mode, id, m1, m2, frais) {
            if (mode === 'add') {
                modalTitle.innerHTML = '<i class="fas fa-plus-circle"></i> Nouveau tarif';
                ...
                modalTitle.innerHTML = '<i class="fas fa-pen"></i> Modifier le tarif';
        ...
        document.getElementById('fraisForm').addEventListener('submit', function(e) {
            ...
            const frais = parseFloat(fraisEnv.value);
